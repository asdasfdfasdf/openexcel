...
# 读取放款pkl文件
loan_datas = pd.read_pickle('E:/BaiduSyncdisk/微粒贷统计/每日数据/20220715/放款20220715100543.pkl')
...
# 读取还款pkl文件
repayment_datas = pd.read_pickle('E:/BaiduSyncdisk/微粒贷统计/每日数据/20220715/还款20220715100635.pkl')
...
# 读取代偿pkl文件
compensation_datas = pd.read_pickle('E:/BaiduSyncdisk/微粒贷统计/每日数据/20220715/代偿20220715100712.pkl')
...
datas.to_excel('E:/BaiduSyncdisk/微粒贷统计/每日数据/20220715/每日还款统计20220715100843.xlsx', index=False)
